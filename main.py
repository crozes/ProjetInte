    ...
    if data == None :
        ...
        for player in result :
            ...
            if player['player_name'] == data['name'] :
                query = "SELECT Player_latitude, Player_longitude, Player_cash, Player_profit, r.Recipe_name  FROM public.Player p, public.Recipe r, public.Avoir a WHERE p.Player_id = a.Player_id AND a.Recipe_id = r.Recipe_id AND public.Player.Player_name LIKE \'"+ data['name']+"\'"
